  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "gle/api/field_behavior.proto\032\031google/api/resource.proto\032#google/cloud/gaming/v1/common.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\032\034google/api/annotations.proto\"\205\002\n"
          + "\035ListGameServerClustersRequest\022E\n"
          + "\006parent\030\001 \001("
          + "\tB5\340A\002\372A/\022-gameservices.googleapis.com/GameServerCluster\022\026\n"
          + "\tpage_size\030\002 \001(\005B\003\340A\001\022\027\n\n"
          + "page_token\030\003 \001(\tB\003\340A\001\022\023\n"
          + "\006filter\030\004 \001(\tB\003\340A\001\022\025\n"
          + "\010order_by\030\005 \001(\tB\003\340A\001\022@\n"
          + "\004view\030\006"
          + " \001(\0162-.google.cloud.gaming.v1.GameServerClusterViewB\003\340A\001\"\227\001\n"
          + "\036ListGameServerClustersResponse\022G\n"
          + "\024game_server_clusters\030\001"
          + " \003(\0132).google.cloud.gaming.v1.GameServerCluster\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\004 \003(\t\"\244\001\n"
          + "\033GetGameServerClusterRequest\022C\n"
          + "\004name\030\001 \001(\tB5\340A\002\372A/\n"
          + "-gameservices.googleapis.com/GameServerCluster\022@\n"
          + "\004view\030\006"
          + " \001(\0162-.google.cloud.gaming.v1.GameServerClusterViewB\003\340A\001\"\331\001\n"
          + "\036CreateGameServerClusterRequest\022E\n"
          + "\006parent\030\001 \001("
          + "\tB5\340A\002\372A/\022-gameservices.googleapis.com/GameServerCluster\022#\n"
          + "\026game_server_cluster_id\030\002 \001(\tB\003\340A\002\022K\n"
          + "\023game_server_cluster\030\003"
          + " \001(\0132).google.cloud.gaming.v1.GameServerClusterB\003\340A\002\"\333\002\n"
          + "%PreviewCreateGameServerClusterRequest\022E\n"
          + "\006parent\030\001 \001("
          + "\tB5\340A\002\372A/\022-gameservices.googleapis.com/GameServerCluster\022#\n"
          + "\026game_server_cluster_id\030\002 \001(\tB\003\340A\002\022K\n"
          + "\023game_server_cluster\030\003"
          + " \001(\0132).google.cloud.gaming.v1.GameServerClusterB\003\340A\002\0225\n"
          + "\014preview_time\030\004 \001(\0132\032.google.protobuf.TimestampB\003\340A\001\022B\n"
          + "\004view\030\006"
          + " \001(\0162-.google.cloud.gaming.v1.GameServerClusterViewB\005\030\001\340A\001\"\275\001\n"
          + "&PreviewCreateGameServerClusterResponse\022\014\n"
          + "\004etag\030\002 \001(\t\0229\n"
          + "\014target_state\030\003 \001(\0132#.google.cloud.gaming.v1.TargetState\022J\n\r"
          + "cluster_state\030\004"
          + " \001(\0132..google.cloud.gaming.v1.KubernetesClusterStateB\003\340A\003\"e\n"
          + "\036DeleteGameServerClusterRequest\022C\n"
          + "\004name\030\001 \001(\tB5\340A\002\372A/\n"
          + "-gameservices.googleapis.com/GameServerCluster\"\243\001\n"
          + "%PreviewDeleteGameServerClusterRequest\022C\n"
          + "\004name\030\001 \001(\tB5\340A\002\372A/\n"
          + "-gameservices.googleapis.com/GameServerCluster\0225\n"
          + "\014preview_time\030\002 \001(\0132\032.google.protobuf.TimestampB\003\340A\001\"q\n"
          + "&PreviewDeleteGameServerClusterResponse\022\014\n"
          + "\004etag\030\002 \001(\t\0229\n"
          + "\014target_state\030\003 \001(\0132#.google.cloud.gaming.v1.TargetState\"\243\001\n"
          + "\036UpdateGameServerClusterRequest\022K\n"
          + "\023game_server_cluster\030\001"
          + " \001(\0132).google.cloud.gaming.v1.GameServerClusterB\003\340A\002\0224\n"
          + "\013update_mask\030\002"
          + " \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\"\341\001\n"
          + "%PreviewUpdateGameServerClusterRequest\022K\n"
          + "\023game_server_cluster\030\001"
          + " \001(\0132).google.cloud.gaming.v1.GameServerClusterB\003\340A\002\0224\n"
          ...
          + "\004etag\030\002 \001(\t\0229\n"
          + "\014target_state\030\003 \001(\0132#.google.cloud.gaming.v1.TargetState\"\227\001\n"
          + "\037GameServerClusterConnectionInfo\022L\n"
          + "\025gke_cluster_reference\030\007"
          + " \001(\0132+.google.cloud.gaming.v1.GkeClusterReferenceH\000\022\021\n"
          ...
          + "\006labels\030\004"
          + " \003(\01325.google.cloud.gaming.v1.GameServerCluster.LabelsEntry\022P\n"
          + "\017connection_info\030\005"
          + " \001(\01327.google.cloud.gaming.v1.GameServerClusterConnectionInfo\022\014\n"
          + "\004etag\030\006 \001(\t\022\023\n"
          + "\013description\030\007 \001(\t\022J\n\r"
          + "cluster_state\030\013"
          + " \001(\0132..google.cloud.gaming.v1.KubernetesClusterStateB\003\340A\003\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\210\001\352A\204\001\n"
          + "-gameservices.googleapis.com/GameServerCluster\022Sprojects/{project}/locations/{location}/realms/{realm}/gameServerClusters/{cluster}\"\347\004\n"
          + "\026KubernetesClusterState\022%\n"
          + "\030agones_version_installed\030\001 \001(\tB\003\340A\003\022)\n"
          + "\034kubernetes_version_installed\030\002 \001(\tB\003\340A\003\022a\n"
          + "\022installation_state\030\003"
          + " \001(\0162@.google.cloud.gaming.v1.KubernetesClusterState.InstallationStateB\003\340A\003\022,\n"
          + "\037version_installed_error_message\030\004 \001(\tB\003\340A\003\022\025\n"
          + "\010provider\030\005 \001(\tB\003\340A\003\022$\n"
          + "\027agones_version_targeted\030\006 \001(\tB\003\340A\003\"\254\002\n"
          + "\021InstallationState\022\"\n"
          + "\036INSTALLATION_STATE_UNSPECIFIED\020\000\022\'\n"
          + "#AGONES_KUBERNETES_VERSION_SUPPORTED\020\001\022\036\n"
          + "\032AGONES_VERSION_UNSUPPORTED\020\002\022)\n"
          + "%AGONES_KUBERNETES_VERSION_UNSUPPORTED\020\003\022\037\n"
          + "\033AGONES_VERSION_UNRECOGNIZED\020\004\022#\n"
          + "\037KUBERNETES_VERSION_UNRECOGNIZED\020\005\022\037\n"
          + "\033VERSION_VERIFICATION_FAILED\020\006\022\030\n"
          + "\024AGONES_NOT_INSTALLED\020\007*V\n"
          + "\025GameServerClusterView\022(\n"
          + "$GAME_SERVER_CLUSTER_VIEW_UNSPECIFIED\020\000\022\t\n"
          + "\005BASIC\020\001\022\010\n"
          + "\004FULL\020\002B\\\n"
          + "\032com.google.cloud.gaming.v1P\001Z<google.golang.org/genproto/googleapis/"
