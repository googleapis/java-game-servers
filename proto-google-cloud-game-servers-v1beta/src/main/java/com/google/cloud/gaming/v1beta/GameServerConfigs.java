...
public final class GameServerConfigs {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "4google/cloud/gaming/v1beta/game_server_configs.proto\022\032google.cloud.gaming.v1be"
          ...
          + "/timestamp.proto\032\034google/api/annotations.proto\"\301\001\n"
          ...
          + " \003(\0132,.google.cloud.gaming.v1beta.GameServerConfig\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\004 \003(\t\"`\n"
          + "\032GetGameServerConfigRequest\022B\n"
          + "\004name\030\001 \001(\tB4\340A\002\372A.\n"
          + ",gameservices.googleapis.com/GameServerConfig\"\314\001\n"
          + "\035CreateGameServerConfigRequest\022D\n"
          + "\006parent\030\001 \001(\tB4\340A\002\372A.\022,games"
          + "ervices.googleapis.com/GameServerConfig\022\026\n"
          + "\tconfig_id\030\002 \001(\tB\003\340A\002\022M\n"
          + "\022game_server_config\030\003"
          + " \001(\0132,.google.cloud.gaming.v1beta.GameServerConfigB\003\340A\002\"c\n"
          + "\035DeleteGameServerConfigRequest\022B\n"
          + "\004name\030\001 \001(\tB4\340A\002\372A.\n"
          + ",gameservices.googleapis.com/GameServerConfig\"\275\001\n\r"
          + "ScalingConfig\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\002\022\"\n"
          + "\025fleet_autoscaler_spec\030\002 \001(\tB\003\340A\002\022<\n"
          + "\tselectors\030\004 \003(\0132).google.cloud.gaming.v1beta.LabelSelector\0227\n"
          ...
          + "\006labels\030\004 "
          + "\003(\01328.google.cloud.gaming.v1beta.GameServerConfig.LabelsEntry\022>\n\r"
          + "fleet_configs\030\005 \003(\0132\'.google.cloud.gaming.v1beta.FleetConfig\022B\n"
          + "\017scaling_configs\030\006"
          + " \003(\0132).google.cloud.gaming.v1beta.ScalingConfig\022\023\n"
          ...
          + "ServerDeployments/{deployment}/configs/{config}B\201\001\n"
          + "\036com.google.cloud.gaming.v1betaP\001Z@google.golang.org/genproto/googlea"
          + "pis/cloud/gaming/v1beta;gaming\312\002\032Google\\Cloud\\Gaming\\V1betab\006proto3"
    };
    descriptor =
